...
import { fireMissile, updateMissiles, updateAlienMissiles, updateUFOMissiles, updateWebBombs, updateBlasterBolts, updateVenomDarts, updateWaspNeedles, updatePrismLances, updateHaloWaves, updateVortexBolts, updateAmbushSpurs, checkAlienFire, resetMissiles, initUFOMissiles, setLevelCompleteCallback } from './missiles.js';
...
export function update() {
    ...
    updatePrismLances(player, scene, gameActive, decreaseLives, gameOver);
    updateHaloWaves(player, scene, gameActive, decreaseLives, gameOver);
    updateVortexBolts(player, scene, gameActive, decreaseLives, gameOver);
